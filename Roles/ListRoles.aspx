<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListRoles.aspx.cs" Inherits="Kesco.App.Web.Roles.ListRoles" %>
...
<h1 class="marginL"><%= Resx.GetString("ROLES_RolesList") %></h1>
<div class="v4formContainer">
    <div id="divDataList" style="overflow: auto">
